    ...
    <>
      <style>{`
        ...
        @keyframes glowYellow {
          ...
          50% {
            box-shadow: 0 0 10px rgba(234, 179, 8, 0.8), 0 0 20px rgba(234, 179, 8, 0.5), 0 0 30px rgba(234, 179, 8, 0.3);
          }
        }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-3">
              ...
              <Button className="bg-yellow-500 text-white rounded-xl hover:bg-yellow-600 glow-yellow px-4 py-2 text-sm">
                SALE
              </Button>
            ...
            <div className="md:hidden absolute left-0 right-0 top-16 bg-white border-b border-border/20 shadow-lg max-h-[calc(100vh-4rem)] overflow-y-auto">
              <nav className="px-4 py-4 space-y-2">
                ...
                <div className="flex gap-2 pb-4 border-b border-border/20">
                  ...
                  <Button className="bg-yellow-500 text-white rounded-xl hover:bg-yellow-600 glow-yellow flex-1 text-sm">
                    SALE
                  </Button>
                  <Button
                    variant="outline"
