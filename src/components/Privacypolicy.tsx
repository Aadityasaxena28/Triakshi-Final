...
export default function PrivacyPolicy() {
  ...
  // 👇 Added useEffect to scroll to top on mount
  useEffect(() => {
  ...
  const sections = [
    ...
    },
    {
      ...
      description:
        "We use cookies and similar technologies to understand website usage and improve content, remember your preferences, and provide relevant advertising (if applicable). You may disable cookies through your browser settings, but this may limit certain website features.",
    },
    {
      id: 4,
      icon: "🤝",
      ...
      description:
        "We do not sell or rent your personal information. We may share your information only with trusted third-party service providers (e.g., payment processors, email platforms) and legal authorities when required by law or to protect our rights.",
    },
    {
      id: 5,
      icon: "🔐",
      ...
      color: "from-yellow-400/20 to-orange-500/10",
      description:
        "We implement appropriate technical and organizational measures to protect your data. While we strive for maximum security, no method of internet transmission is 100% secure.",
    },
    {
      id: 6,
      icon: "👤",
      ...
      color: "from-orange-400/20 to-red-500/10",
      description:
        "Depending on your jurisdiction, you may have the right to access, update, or delete your personal data, withdraw consent for communication, request information on how your data is used, and lodge a complaint with a regulatory authority.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-900 via-orange-800 to-red-900 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Policy Sections */}
        <div
          className={`max-w-4xl mx-auto px-6 mb-16 space-y-6 transition-opacity duration-1000 ${
        ...
        <div className="text-center py-12 border-t border-yellow-400/30">
          ...
          <p className="text-amber-300 text-xs">Last Updated: October 2025</p>
        </div>
      </div>
    </div>
  );
