  ...
  const offerings = [
    {
      ...
      description:
        "Natural, lab-tested, and astrologically recommended stones by Gemological Laboratory Of India (GLI).",
    },
    {
      icon: "🔱",
      title: "Energized Rudraksha & Malas",
      description:
        "From Ek Mukhi to Panchmukhi, blessed with specific purposes.",
    },
    {
      icon: "📿",
      title: "Spiritual Bracelets & Yantras",
      description:
        "Designed for protection, manifestation, and energy balance.",
    },
    {
      icon: "🌠",
      ...
      <div className="relative z-10">
        ...
        <div className="text-center pt-16 pb-12 px-6">
          ...
          <p className="text-xl text-amber-100 font-semibold">
            The Divine Connection Between You and the Universe
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 mb-16">
          <div className="bg-gradient-to-br from-orange-900/50 to-red-900/50 backdrop-blur-sm border-2 border-yellow-400/30 rounded-2xl p-10 shadow-2xl">
            <p className="text-amber-50 text-lg leading-relaxed mb-6">
              Welcome to{" "}
              <span className="font-bold text-yellow-300">Triakshi</span> – a
              sacred space where energy, purity, and intention come together.
              Founded and blessed by Astrologer & Tantra Guru{" "}
              <span className="font-bold text-orange-200">Ashok Narayann</span>,
              we offer authentic gemstones, semi-precious stones, Rudraksha malas,
              spiritual bracelets, and sacred yantras — each energized and blessed
              as per ancient Vedic and Tantrik traditions.
            </p>
            <p className="text-amber-100 text-lg leading-relaxed">
              At Triakshi, every product is chosen with deep spiritual insight and
              astrological precision. Whether you seek to balance your planets,
              attract prosperity, remove negative energies, or deepen your
              meditation, our divine collection helps align your aura with cosmic
              vibrations.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 mb-16">
          <div className="bg-gradient-to-br from-red-900/50 to-orange-900/50 backdrop-blur-sm border-2 border-yellow-400/30 rounded-2xl p-10 shadow-2xl">
            ...
            <p className="text-amber-50 text-lg leading-relaxed mb-4">
              <span className="text-yellow-300 font-bold">Triakshi</span> means
              "Three-Eyed", symbolizing the divine vision of Lord Shiva — the
              power of insight, protection, and transformation.
            </p>
            <p className="text-amber-100 text-lg leading-relaxed mb-4">
              Under the guidance of Guruji Ashok Narayann, a renowned astrologer
              and Tantra master, we believe that true healing happens when
              material and spiritual energies meet in harmony.
            </p>
            <p className="text-amber-50 text-lg leading-relaxed">
              Each gemstone and Rudraksha is personally checked, purified, and
              energized by mantra and fire rituals to ensure you receive not just
              a product, but a living vibration of divine energy.
            </p>
          </div>
        </div>
            ...
            {offerings.map((offer, index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-amber-800/60 to-orange-800/40 backdrop-blur-sm border-2 border-yellow-400/40 rounded-xl p-8 shadow-2xl group-hover:border-yellow-300/70 transition-all duration-300 h-full">
                  ...
                  <div className="absolute top-3 right-3 text-yellow-400 opacity-30 text-xl">
                    ✦
                  </div>
                  <div className="absolute bottom-3 left-3 text-orange-300 opacity-20 text-lg">
                    ✦
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              {reasons.map((reason, index) => (
                <div key={index} className="flex items-start gap-4 group">
                  ...
                  <p className="text-amber-50 text-lg group-hover:text-yellow-200 transition-colors">
                    {reason}
                  </p>
                </div>
              ))}
        ...
        <div className="max-w-4xl mx-auto px-6 mb-16">
          <div className="bg-gradient-to-r from-yellow-400/20 via-orange-400/20 to-red-400/20 backdrop-blur-sm border-2 border-yellow-400/50 rounded-2xl p-12 shadow-2xl text-center">
            ...
            <p className="text-amber-50 text-lg leading-relaxed">
              To bring the ancient power of astrology and tantra into modern lives
              through authentic spiritual products — helping every soul align with
              destiny, heal karmas, and live in divine abundance.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-amber-100 text-lg">
                ...
                <span className="text-orange-200 font-bold">
                  @AstrologerAshokNarayann
                </span>
              </p>
              <p className="text-amber-50 italic">
                For personal recommendations & blessings from Ashok Narayann
                Guruji
              </p>
            </div>
          </div>
